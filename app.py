...
resume_link = (
    "https://drive.google.com/file/d/1fg-UZmT4t5EJl6ypbx4J-_uDcNRlAMUt/view?usp=sharing"
)
cover_letter = (
    "https://drive.google.com/file/d/128T_BkhyCaFCBhmiXrU7jN8SN3KuLFUa/view?usp=sharing"
)
...
with col2:
    ...
    st.write(
        """AI Engineer and Aspiring Data Scientist. The Generator AI Lab
...
st.write(
    """From automating mobile game currency sales at age twelve to engineering 
...
st.write(
    """As an AI Engineer interning at Barbaricum, I'm at the forefront of 
...
st.write(
    """My entrepreneurial background, which includes founding several 
...
st.write(
    """Currently pursuing a BS in Business Administration with a concentration 
...
st.write(
    """I'm passionate about leveraging AI to create positive change across 
...
for i, (category, skill_list) in enumerate(skills.items()):
    with col1 if i % 2 == 0 else col2:
        ...
        skills_html = (
            ...
            + "<br>".join([f"• {skill}" for skill in skill_list])
            + "</div>"
        )
...
with colm1:
    st.subheader("Hockey 🥅")
    st.write(
        """I am a huge hockey fan, and love crunching different hockey  
...
with colm2:
    ...
    st.write(
        """My dad is a photographer specializing in sports and I am now  
...
with colm3:
    ...
    st.write(
        """I'm a little bit of a numbers nerd when it comes to hockey. I've
